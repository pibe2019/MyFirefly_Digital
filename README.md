...
- ARQUITECTURA: MVVM
- PRINCIPIOS: SOLID, CLEAN ARQUITECTURE
- PATRONES: SINGLETON, DEBOUNCE(espera un tiempo antes de ejecutar algo)
- INYECION DE DEPENDENCIAS: DAGGER HILT
- ROOM: persistencia local de datos
- MATERIAL DESING 3 - JETPACK COMPOSE
- LA APP esta implementada de forma REACTIVA: estateFlot.
